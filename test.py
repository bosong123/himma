...
def on_open(self):
    ...
    print("##open##")
    sendMsg = "{'event':'addChannel',\"channel\":\"ok_sub_spot_btc_usdt_kline_15min\",'parameters':{\"base\":\"btc\",\"binary\":\"0\",\"period\":\"1min\",\"product\":\"spot\",\"quote\":\"usd\",\"type\":\"kline\"}}"
    self.send(sendMsg)
    def run(*args):
        while(True) :
...
if __name__ == "__main__":
    ...
    ws = websocket.WebSocketApp("wss://real.okex.com:10440/websocket",
